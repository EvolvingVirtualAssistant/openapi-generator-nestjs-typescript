 ...
 * 1) Set a break point in NestjsTypescriptServerGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class NestjsTypescriptServerGeneratorTest {
